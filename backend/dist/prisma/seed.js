...
async function main() {
    ...
    const engineering = await prisma.department.create({
        data: { name: "Engineering", status: client_1.UserStatus.ACTIVE },
    });
    const marketing = await prisma.department.create({
        data: { name: "Marketing", status: client_1.UserStatus.ACTIVE },
    });
    const operations = await prisma.department.create({
        data: { name: "Operations", status: client_1.UserStatus.ACTIVE },
    });
    ...
    const manager1 = await prisma.user.create({
        data: {
            ...
            password: hashedPassword,
            role: client_1.Role.ASSET_MANAGER,
            status: client_1.UserStatus.ACTIVE,
            departmentId: engineering.id,
        },
    });
    ...
    const deptHead1 = await prisma.user.create({
        data: {
            ...
            password: hashedPassword,
            role: client_1.Role.DEPARTMENT_HEAD,
            status: client_1.UserStatus.ACTIVE,
            departmentId: engineering.id,
        },
    });
    ...
    const assets = await Promise.all([
        ...
        prisma.asset.create({
            data: {
                ...
                departmentId: engineering.id, status: client_1.AssetStatus.ALLOCATED,
            },
        }),
        prisma.asset.create({
            data: {
                ...
                departmentId: engineering.id, status: client_1.AssetStatus.AVAILABLE,
            },
        }),
        prisma.asset.create({
            data: {
                ...
                departmentId: marketing.id, status: client_1.AssetStatus.ALLOCATED,
            },
        }),
        prisma.asset.create({
            data: {
                ...
                departmentId: marketing.id, status: client_1.AssetStatus.AVAILABLE,
            },
        }),
        prisma.asset.create({
            data: {
                ...
                departmentId: operations.id, status: client_1.AssetStatus.UNDER_MAINTENANCE,
            },
        }),
        prisma.asset.create({
            data: {
                ...
                departmentId: operations.id, status: client_1.AssetStatus.RETIRED,
            },
        }),
        // Furniture (4)
        prisma.asset.create({
        ...
        prisma.asset.create({
            data: {
                ...
                departmentId: null, status: client_1.AssetStatus.AVAILABLE,
            },
        }),
        prisma.asset.create({
            data: {
                ...
                departmentId: operations.id, status: client_1.AssetStatus.AVAILABLE,
            },
        }),
        // Vehicles (3)
        prisma.asset.create({
            data: {
                ...
                departmentId: operations.id, status: client_1.AssetStatus.ALLOCATED,
            },
        }),
        prisma.asset.create({
            data: {
        ...
        prisma.asset.create({
            data: {
                ...
                departmentId: operations.id, status: client_1.AssetStatus.LOST,
            },
        }),
        ...
        prisma.asset.create({
            data: {
                ...
                isBookable: true, status: client_1.AssetStatus.AVAILABLE,
            },
        }),
        prisma.asset.create({
            data: {
        ...
        prisma.asset.create({
            data: {
                ...
                isBookable: true, status: client_1.AssetStatus.UNDER_MAINTENANCE,
            },
        }),
        ...
        prisma.asset.create({
            data: {
                ...
                departmentId: engineering.id, status: client_1.AssetStatus.DISPOSED,
            },
        }),
    ]);
    ...
    await prisma.maintenanceRequest.create({
        data: {
            ...
            status: client_1.MaintenanceStatus.TECHNICIAN_ASSIGNED,
    ...
    await prisma.maintenanceRequest.create({
        data: {
            ...
            status: client_1.MaintenanceStatus.REJECTED,
    ...
    const auditCycle = await prisma.auditCycle.create({
        data: {
            ...
            status: client_1.AuditCycleStatus.OPEN,
        },
    });
    ...
    const engineeringAssets = assets.filter((a) => [assets[0].id, assets[1].id, assets[6].id, assets[7].id, assets[17].id, assets[18].id].includes(a.id));
    for (const asset of engineeringAssets) {
        await prisma.auditEntry.create({
            data: {
                auditCycleId: auditCycle.id,
                assetId: asset.id,
                status: client_1.AuditEntryStatus.PENDING,
            },
        });
    }
